...
<blockquote>👇 नीचे दिए गए विकल्पों में से movie के नाम की सही spelling चुनें</blockquote>"""
    ...
    DEL_MSG = """<b>❗️⚠️ ɪᴍᴘᴏʀᴛᴀɴᴛ ᴡᴀʀɴɪɴɢ ⚠️❗️</b>

<b>📁 ᴛʜɪs ᴍᴏᴠɪᴇ ꜰɪʟᴇ / ᴠɪᴅᴇᴏ</b>
<b>ᴡɪʟʟ ʙᴇ <u>ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ</u></b>

<b>⏳ ᴅᴇʟᴇᴛɪᴏɴ ᴛɪᴍᴇ :</b> <b><code>{}</code></b> 🫥  
<i>(ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs)</i>

<blockquote>
<b>📤 ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰɪʟᴇ</b>  
<b>ᴛᴏ sᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ & ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ</b>

⚠️ यह फ़ाइल <b>⏳ <code>{}</code></b> में  
