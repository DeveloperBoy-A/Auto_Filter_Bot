...
<blockquote>👇 नीचे दिए गए विकल्पों में से movie के नाम की सही spelling चुनें</blockquote>"""
    ...
    DEL_MSG = """**❗️⚠️ ɪᴍᴘᴏʀᴛᴀɴᴛ ᴡᴀʀɴɪɴɢ ⚠️❗️**
────────────────────
📁 ᴛʜɪs ᴍᴏᴠɪᴇ ꜰɪʟᴇ / ᴠɪᴅᴇᴏ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ
 
⏳ ᴅᴇʟᴇᴛɪᴏɴ ᴛɪᴍᴇ : <b><u><code>{}</code></u></b>  🫥 (ᴅᴜᴇ ᴛᴏ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs)

⚠️ यह फ़ाइल <b><u><code>{}</code></u></b>  में स्वचालित रूप से हटा दी जाएगी
 
<blockquote expandable><b><i>📌 इसे अपने 𝐒𝐀𝐕𝐄𝐃 𝐌𝐄𝐒𝐒𝐀𝐆𝐄𝐒 पर अग्रेषित करें और उसके बाद डाउनलोड करें।</i></b></blockquote>
