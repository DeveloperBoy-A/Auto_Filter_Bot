...
LANGUAGE_ALIASES = {
    ...
    "Haryanvi": [r'\bharyanvi\b', r'\bharyanavi\b', r'\bharyanwi\b', r'\bhry\b'],
    "Bhojpuri": [r'\bbhojpuri\b', r'\bbho\b'],
    "Assamese": [r'\bassamese\b', r'\basm\b', r'\baxomiya\b'],
    "Odia": [r'\bodia\b', r'\boriya\b', r'\bod\b'],
    "Kashmiri": [r'\bkashmiri\b', r'\bkas\b'],
    "Sindhi": [r'\bsindhi\b', r'\bsnd\b'],
    "Nepali": [r'\bnepali\b', r'\bnep\b'],
    "Konkani": [r'\bkonkani\b', r'\bkok\b'],
    "Maithili": [r'\bmaithili\b', r'\bmai\b'],
    "Rajasthani": [r'\brajasthani\b', r'\braj\b'],
    "Manipuri": [r'\bmanipuri\b', r'\bmeitei\b'],
    "Sanskrit": [r'\bsanskrit\b', r'\bsan\b'],

    "Korean": [r'\bkorean\b', r'\bkor\b', r'\bk-drama\b', r'\bkdrama\b'],
    "Japanese": [r'\bjapanese\b', r'\bjap\b', r'\bjpn\b'],
    "Chinese": [r'\bchinese\b', r'\bmandarin\b', r'\bchi\b', r'\bchn\b'],
    "Spanish": [r'\bspanish\b', r'\besp\b', r'\bspa\b'],
    "Russian": [r'\brussian\b', r'\brus\b', r'\brus\b'],
    "French": [r'\bfrench\b', r'\bfre\b', r'\bfra\b'],
    "German": [r'\bgerman\b', r'\bger\b', r'\bdeu\b'],
    "Italian": [r'\bitalian\b', r'\bita\b'],
    "Portuguese": [r'\bportuguese\b', r'\bpor\b'],
    "Arabic": [r'\barabic\b', r'\bara\b'],
    "Turkish": [r'\bturkish\b', r'\btur\b'],
    "Persian": [r'\bpersian\b', r'\bper\b', r'\bfarsi\b'],
    "Urdu": [r'\burdu\b', r'\burd\b'],
    "Thai": [r'\bthai\b', r'\btha\b'],
    "Indonesian": [r'\bindonesian\b', r'\bind\b'],
    "Malay": [r'\bmalay\b', r'\bmsa\b'],
    "Vietnamese": [r'\bvietnamese\b', r'\bvie\b'],
    "Filipino": [r'\bfilipino\b', r'\btagalog\b', r'\bfil\b'],
    "Dutch": [r'\bdutch\b', r'\bnld\b'],
    "Polish": [r'\bpolish\b', r'\bpol\b'],
    "Swedish": [r'\bswedish\b', r'\bswe\b'],
    "Danish": [r'\bdanish\b', r'\bdan\b'],
    "Finnish": [r'\bfinnish\b', r'\bfin\b'],
    "Norwegian": [r'\bnorwegian\b', r'\bnor\b'],
    "Greek": [r'\bgreek\b', r'\bgre\b'],
    "Hebrew": [r'\bhebrew\b', r'\bheb\b'],
    "Ukrainian": [r'\bukrainian\b', r'\bukr\b']
}
