...
async def start(client, message):
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(
                f"<b><u>❗️⚠️❗️IMPORTANT WARNING❗️️⚠️❗️</u></b>\n\n"
                f"ᴛʜɪꜱ ᴍᴏᴠɪᴇ ꜰɪʟᴇ/ᴠɪᴅᴇᴏ ᴡɪʟʟ ʙᴇ AUTOMATICALLY ᴅᴇʟᴇᴛᴇᴅ ɪɴ <b><u><code>{get_time(DELETE_TIME)}</code></u> 🫥 <i></b>"
