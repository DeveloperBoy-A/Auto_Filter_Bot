...
# ============================
SESSION = environ.get('SESSION', 'Newmovie_sbot')   # Session name for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'Newmovie_sbot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'Newmovie_sbot'))
