...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002269396456'))  # Bin channel id (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002269396456')  # Request channel id (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002406952437 -1002785329474'))  # Notification of sent to your channel
